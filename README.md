...
```
For most users, that is all that is required. If you are running on Linux, you need to change `INCLUDE_LIBPTHREAD=0` setting located at `options-config.ini` to `INCLUDE_LIBPTHREAD=1`
