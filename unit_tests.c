...
/*   Updated: 2020/06/10 22:23:52 by apuchill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Null specifier tests
 int notrequired_nocrash_nullspec_basic(void){return test("%");}
 int notrequired_nocrash_nullspec_5w(void){return test("%5");}
 int notrequired_nocrash_nullspec_5wzp(void){return test("%05");}
 int notrequired_nocrash_nullspec_5wzplj(void){return test("%-05");}
 int notrequired_nocrash_nullspec_5wlj(void){return test("%-5");}
...
//No-crash-no-segfault test
 int notrequired_nocrash_noarg_1(void){return test("%1$"); }
 int notrequired_nocrash_noarg_2(void){return test("%0"); }
 int notrequired_nocrash_noarg_3(void){return test("% "); }
 int notrequired_nocrash_noarg_5(void){return test("%-"); }
 int notrequired_nocrash_noarg_6(void){return test("%+"); }
 int notrequired_nocrash_noarg_9(void){return test("%23"); }
 int notrequired_nocrash_noarg_10(void){return test("%."); }
 int notrequired_nocrash_noarg_16(void){return test("%p"); }
 int notrequired_nocrash_noarg_17(void){return test("%d"); }
 int notrequired_nocrash_noarg_19(void){return test("%u"); }
 int notrequired_nocrash_noarg_20(void){return test("%x"); }
 int notrequired_nocrash_noarg_21(void){return test("%X"); }
 int notrequired_nocrash_noarg_22(void){return test("%f"); }
 int notrequired_nocrash_noarg_24(void){return test("%c"); }
 int notrequired_nocrash_noarg_25(void){return test("%o"); }
 int notrequired_nocrash_nullarg_1(void){return test("%1$s", NULL); }
 int notrequired_nocrash_nullarg_2(void){return test("%0s", NULL); }
 int notrequired_nocrash_nullarg_3(void){return test("% s", NULL); }
 int notrequired_nocrash_nullarg_5(void){return test("%-s", NULL); }
 int notrequired_nocrash_nullarg_6(void){return test("%+s", NULL); }
 int notrequired_nocrash_nullarg_9(void){return test("%23s", NULL); }
 int notrequired_nocrash_nullarg_10(void){return test("%.s", NULL); }
 int notrequired_nocrash_nullarg_16(void){return test("%p", NULL); }
 int notrequired_nocrash_nullarg_17(void){return test("%d", NULL); }
 int notrequired_nocrash_nullarg_18(void){return test("%b", NULL); }
 int notrequired_nocrash_nullarg_19(void){return test("%u", NULL); }
 int notrequired_nocrash_nullarg_20(void){return test("%x", NULL); }
 int notrequired_nocrash_nullarg_21(void){return test("%X", NULL); }
 int notrequired_nocrash_nullarg_22(void){return test("%f", NULL); }
 int notrequired_nocrash_nullarg_23(void){return test("%s", NULL); }
 int notrequired_nocrash_nullarg_24(void){return test("%c", NULL); }
 int notrequired_nocrash_nullarg_25(void){return test("%o", NULL); }
//nocrash tests adapted from tests contributed by phtruong
 int notrequired_nocrash_dupflag_d_ljljw(void){return test("%--5d", 42);}
//nocrash tests that came about as part of the minimal specification
 int notrequired_nocrash_c_prec_1(void){return test("%.4c", 'a');}
 int notrequired_nocrash_c_prec_2(void){return test("%.c", 'a');}
 int notrequired_nocrash_c_zp_1(void){return test("%05c", 'a');}
 int notrequired_nocrash_c_zp_2(void){return test("%0c", 'a');}
 int notrequired_nocrash_c_lj_nowidth(void){return test("%-c", 'a');}
 int notrequired_nocrash_s_zp_1(void){return test("%05s", "hello");}
 int notrequired_nocrash_s_zp_2(void){return test("%0s", "hello");}
 int notrequired_nocrash_s_lj_nowidth(void){return test("%-s", "hello");}

static int ncm_p = 5;
 int notrequired_nocrash_p_prec_1(void){return test("%.4p", &ncm_p);}
 int notrequired_nocrash_p_prec_2(void){return test("%.p", &ncm_p);}
 int notrequired_nocrash_p_zp_1(void){return test("%05p", &ncm_p);}
 int notrequired_nocrash_p_zp_2(void){return test("%0p", &ncm_p);}
 int notrequired_nocrash_p_lj_nowidth(void){return test("%-p", &ncm_p);}
 int notrequired_nocrash_i_lj_nowidth(void){return test("%-i", 42);}
 int notrequired_nocrash_u_lj_nowidth(void){return test("%-u", 42);}
 int notrequired_nocrash_x_lj_nowidth(void){return test("%-x", 42);}
 int notrequired_nocrash_f_lj_nowidth(void){return test("%-f", 42.5);}
...
//nocrash tests adapted from tests contributed by phtruong
 int notrequired_bonus_as_nocrash_dupflag_d(void){return test("%++d", 42);}
 int notrequired_bonus_as_nocrash_dupflag_d_ljasljw(void){return test("%-+-5d", 42);}
 int notrequired_bonus_as_nocrash_c_1(void){return test("%+c", 'a');}
 int notrequired_bonus_as_nocrash_c_2(void){return test("%+c", -42);}
 int notrequired_bonus_as_nocrash_s_1(void){return test("%+s", "hello");}
 int notrequired_bonus_as_nocrash_p_1(void){return test("%+p", &ncm_p);}
 int notrequired_bonus_as_nocrash_p_2(void){return test("%+p", &ncm_p);}
 int notrequired_bonus_as_nocrash_u(void){return test("%+u", 42);}
 int notrequired_bonus_as_nocrash_x(void){return test("%+x", 42);}
 int notrequired_bonus_as_nocrash_X(void){return test("%+X", 42);}
...
//nocrash tests adapted from tests contributed by phtruong
 int notrequired_bonus_sp_nocrash_dupflag_d(void){return test("%  d", 42);}
//nocrash tests that came about as part of the minimal specification
 int notrequired_bonus_sp_nocrash_c_1(void){return test("% c", 'a');}
 int notrequired_bonus_sp_nocrash_c_2(void){return test("% c", -42);}
 int notrequired_bonus_sp_nocrash_s_1(void){return test("% s", "hello");}
 int notrequired_bonus_sp_nocrash_p_1(void){return test("% p", &ncm_p);}
 int notrequired_bonus_sp_nocrash_p_2(void){return test("% p", &ncm_p);}
 int notrequired_bonus_sp_nocrash_u(void){return test("% u", 42);}
 int notrequired_bonus_sp_nocrash_x(void){return test("% x", 42);}
 int notrequired_bonus_sp_nocrash_X(void){return test("% X", 42);}
...
//No-crash-no-segfault test
 int notrequired_bonus_af_nocrash_noarg_4(void){return test("%#"); }
 int notrequired_bonus_af_nocrash_nullarg_4(void){return test("%#s", NULL); }
//nocrash tests adapted from tests contributed by phtruong
 int notrequired_bonus_af_nocrash_dupflag_x(void){return test("%##x", 42);}
 int notrequired_bonus_af_nocrash_dupflag_xasasljw(void){return test("%#++#-5x", 42);}
//nocrash tests that came about as part of the minimal specification
 int notrequired_bonus_af_nocrash_c(void){return test("%#c", 'a');}
 int notrequired_bonus_af_nocrash_s(void){return test("%#s", "hello");}
 int notrequired_bonus_af_nocrash_p(void){return test("%#p", &ncm_p);}
 int notrequired_bonus_af_nocrash_d(void){return test("%#d", 42);}
 int notrequired_bonus_af_nocrash_i(void){return test("%#i", 42);}
 int notrequired_bonus_af_nocrash_u(void){return test("%#u", 42);}
...
//nocrash tests adapted from tests contributed by phtruong
 int notrequired_bonus_assp_nocrash_dupflag_d_spassp(void){return test("% + d", 42);}
...
//No-crash-no-segfault test
 int notrequired_bonus_length_nocrash_noarg_11(void){return test("%hh"); }
 int notrequired_bonus_length_nocrash_noarg_12(void){return test("%h"); }
 int notrequired_bonus_length_nocrash_noarg_13(void){return test("%ll"); }
 int notrequired_bonus_length_nocrash_noarg_14(void){return test("%l"); }
 int notrequired_bonus_length_nocrash_nullarg_11(void){return test("%hhs", NULL); }
 int notrequired_bonus_length_nocrash_nullarg_12(void){return test("%hs", NULL); }
 int notrequired_bonus_length_nocrash_nullarg_13(void){return test("%lls", NULL); }
 int notrequired_bonus_length_nocrash_nullarg_14(void){return test("%ls", NULL); }
 int notrequired_bonus_length_nocrash_c_hh(void){return test("%hhc", 'a');}
 int notrequired_bonus_length_nocrash_c_h(void){return test("%hc", 'a');}
 int notrequired_bonus_length_nocrash_c_l(void){return test("%lc", 'a');}
 int notrequired_bonus_length_nocrash_c_ll(void){return test("%llc", 'a');}
 int notrequired_bonus_length_nocrash_s_hh(void){return test("%hhs", "hello");}
 int notrequired_bonus_length_nocrash_s_h(void){return test("%hs", "hello");}
 int notrequired_bonus_length_nocrash_s_l(void){return test("%s", "hello");}
 int notrequired_bonus_length_nocrash_s_ll(void){return test("%lls", "hello");}
 int notrequired_bonus_length_nocrash_p_hh(void){return test("%hhp", &ncm_p);}
 int notrequired_bonus_length_nocrash_p_h(void){return test("%hp", &ncm_p);}
 int notrequired_bonus_length_nocrash_p_l(void){return test("%lp", &ncm_p);}
 int notrequired_bonus_length_nocrash_p_ll(void){return test("%llp", &ncm_p);}
 int notrequired_bonus_length_nocrash_d_hhh(void){return test("%hhhd", 42);}
 int notrequired_bonus_length_nocrash_d_hhhh(void){return test("%hhhhd", 42);}
 int notrequired_bonus_length_nocrash_d_hhl(void){return test("%hhld", 42);}
 int notrequired_bonus_length_nocrash_d_hhll(void){return test("%hhlld", 42);}
 int notrequired_bonus_length_nocrash_d_llh(void){return test("%llhd", 42);}
 int notrequired_bonus_length_nocrash_d_lll(void){return test("%llld", 42);}
 int notrequired_bonus_length_nocrash_i_hhh(void){return test("%hhhi", 42);}
 int notrequired_bonus_length_nocrash_u_hhh(void){return test("%hhhu", 42);}
 int notrequired_bonus_length_nocrash_u_hhhh(void){return test("%hhhhu", 42);}
 int notrequired_bonus_length_nocrash_u_hhl(void){return test("%hhlu", 42);}
 int notrequired_bonus_length_nocrash_u_hhll(void){return test("%hhllu", 42);}
 int notrequired_bonus_length_nocrash_u_llh(void){return test("%llhu", 42);}
 int notrequired_bonus_length_nocrash_u_lll(void){return test("%lllu", 42);}
 int notrequired_bonus_length_nocrash_x_hhh(void){return test("%hhhx", 42);}
 int notrequired_bonus_length_nocrash_x_hhhh(void){return test("%hhhhx", 42);}
 int notrequired_bonus_length_nocrash_x_hhl(void){return test("%hhlx", 42);}
 int notrequired_bonus_length_nocrash_x_hhll(void){return test("%hhllx", 42);}
 int notrequired_bonus_length_nocrash_x_llh(void){return test("%llhx", 42);}
 int notrequired_bonus_length_nocrash_x_lll(void){return test("%lllx", 42);}
 int notrequired_bonus_length_nocrash_X_hhh(void){return test("%hhhX", 42);}
 int notrequired_bonus_length_nocrash_X_llh(void){return test("%llhX", 42);}
 int notrequired_bonus_length_nocrash_f_hh(void){return test("%hhf", 42.5);}
 int notrequired_bonus_length_nocrash_f_h(void){return test("%hf", 42.5);}
 int notrequired_bonus_length_nocrash_f_ll(void){return test("%llf", 42.5);}
 int notrequired_bonus_length_nocrash_f_lll(void){return test("%lllf", 42.5);}
 int notrequired_bonus_length_nocrash_f_llll(void){return test("%llllf", 42.5);}
...
//Octals - zero precision zero value
 ...
 int notinsubject_notrequired_o_nocrash_sp(void){return test("% o", 42);}
 int notinsubject_notrequired_o_nocrash_hhh(void){return test("%hhho", 42);}
 int notinsubject_notrequired_o_nocrash_hhhh(void){return test("%hhhho", 42);}
 int notinsubject_notrequired_o_nocrash_hhl(void){return test("%hhlo", 42);}
 int notinsubject_notrequired_o_nocrash_hhll(void){return test("%hhllo", 42);}
 int notinsubject_notrequired_o_nocrash_llh(void){return test("%llho", 42);}
 int notinsubject_notrequired_o_nocrash_lll(void){return test("%lllo", 42);}
 int notinsubject_notrequired_o_nocrash_lj_nowidth(void){return test("%-o", 42);}
 int notinsubject_notrequired_o_nocrash_as(void){return test("%+o", 42);}
